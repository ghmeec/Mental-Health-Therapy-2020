...
const UsersScreen = () => {
  ...
  return (
    <Layout style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      <Text style={{ marginVertical: 10, color: "red", width: 260 }}>
        {errorMessage}
      </Text>
      <Input
        label="Email"
...
const RecoverPassword = () => {
  ...
  const HandlePasswordRecovery = () => {
    ...
    firebase
      ...
      .then(function () {
        setMessage("Password reset email is sent to  " + email);
        // setVisible(false);
        setLoading(false);
        // Email sent.
      })
  ...
  return (
    <View style={{ marginTop: 22 }}>
      ...
      >
        <View>
          <Text style={{ color: "#0771EC" }}>Forgot passowrd ?</Text>
        </View>
      </TouchableOpacity>
      <Modal
        visible={visible}
...
const TabNavigator = () => (
  ...
  >
    <View
      style={{ height: 10, backgroundColor: "#0771EC", opacity: 0.9 }}
    ></View>
    <Navigator
